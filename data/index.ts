...
export const projects = [
  ...
  {
    id: 2,
    title: "Live Docs App - Real-time Collaboration",
    des: "A document collaboration app that allows users to edit and work on documents simultaneously in real time.",
    // img: "https://github.com/user-attachments/assets/eaaeb1f0-22da-46be-9e29-9bef70e0039d",
    img: "/livedocsio.png",
...
export const workExperience = [
  {
    ...
    desc: "Delivered a production-ready website for Siya Jewels Infotech, handling UI development, responsive layouts, performance optimization, and deployment. Collaborated directly with the client to translate business requirements into a polished web presence.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
    projects: [
      {
        name: "Siya Jewels Infotech",
        url: "https://siyajewelsinfotech.com",
      },
    ],
  },
...
export const socialMedia = [
  {
    id: 1,
    img: "/git.svg",
    link: "https://github.com/sudeepprajapati"
  },
  {
    id: 2,
    img: "/link.svg",
